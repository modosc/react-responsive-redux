...
describe('parser', () => {
  ...
  context('with a phone', () => {
    ...
    it('works', () => {
      expect(parser(req(ua)))
        .to.deep.equal({ phone: true, tablet: false, mobile: true, desktop: false })
    })
  })
  context('with a tablet', () => {
    ...
    it('works', () => {
      expect(parser(req(ua)))
        .to.deep.equal({ phone: false, tablet: true, mobile: true, desktop: false })
    })
  })
  context('with a desktop', () => {
    ...
    it('works', () => {
      expect(parser(req(ua)))
        .to.deep.equal({ phone: false, tablet: false, mobile: false, desktop: true })
    })
  })
