...
var TabletScreenHidden = exports.TabletScreenHidden = responsiveWrapper({ query: '(max-width: ' + _defaults.breakPoints.phone + 'px) or (min-width: ' + (_defaults.breakPoints.tablet + 1) + 'px)' });
